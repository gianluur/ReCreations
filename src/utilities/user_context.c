...
static void build_msvc_version(char *buffer, int full_ver, int ver) {
...
UserContext getUserContext() {
  const UserContext context = {
    ...
    .compiler = COMPILER_NAME,
        ...
        build_msvc_version(context.compiler_version, _MSC_FULL_VER, _MSC_VER);
      #else 
        build_msvc_version(context.compiler_version, _MSC_VER * 10000, _MSC_VER);
      #endif
    #else
