...
// Required because the compiler doesn't expand macro arguments inside stringification
...
(defined(compiler_name) && COMPILER_VERSION_NORMALIZED >= COMPILER_NORMALIZED_VERSION(v, r, p))
...
#define COMPILER_VERSION_NORMALIZED NORMALIZED_VERSION( \
    COMPILER_VERSION_MAJOR, \
    COMPILER_VERSION_MINOR, \
    COMPILER_VERSION_PATCH)

#define COMPILER_VERSION COMPILER_EXPAND_STRING( \
    COMPILER_VERSION_MAJOR, \
    COMPILER_VERSION_MINOR, \
    COMPILER_VERSION_PATCH)
...
#define COMPILER_VERSION_NORMALIZED NORMALIZED_VERSION(__clang_major__, __clang_minor__, __clang_patchlevel__)
#define COMPILER_VERSION COMPILER_EXPAND_STRING(__clang_major__, __clang_minor__, __clang_patchlevel__)
...
#define COMPILER_NAME "GCC"
    ...
    #define COMPILER_VERSION_NORMALIZED NORMALIZED_VERSION(__GNUC__, __GNUC_MINOR__, __GNUC_PATCHLEVEL__)
    #define COMPILER_VERSION COMPILER_EXPAND_STRING(__GNUC__, __GNUC_MINOR__, __GNUC_PATCHLEVEL__)

#else
    #define COMPILER_VERSION_NORMALIZED NORMALIZED_VERSION(__GNUC__, __GNUC_MINOR__, 0)
